...
export const defaultFaqData: Record<string, FAQItemData[]> = {
  "web-dev": [
    {
...
export const FAQ: React.FC<FAQProps> = ({
  ...
  const [selectedCategory, setSelectedCategory] = useState<string>(categoryKeys[0] || "web-dev")

  return (
    <section
      className={cn(
        "relative overflow-hidden bg-background px-4 sm:px-8 lg:px-16 py-12 text-foreground min-h-screen w-full flex flex-col justify-center",
        className
      )}
      {...props}
    >
      <div className="pointer-events-none absolute -top-[5%] -left-[5%] w-[110%] h-[110%] z-0 origin-top-left">
...
const FAQList: React.FC<FAQListProps> = ({ faqData, selected }) => (
  <div className="relative z-10 mx-auto mt-12 max-w-5xl w-full">
